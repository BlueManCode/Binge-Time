      ...
      <IonReactRouter>
        <IonTabs>
          ...
          <IonTabBar className="tab-bar" slot="bottom">
            <IonTabButton className="tab-btn" tab="tab1" href="/tab1">
              <IonIcon icon={triangle} />
              <IonLabel>Tab 1</IonLabel>
            </IonTabButton>
            <IonTabButton className="tab-btn" tab="tab2" href="/tab2">
              <IonIcon icon={ellipse} />
              <IonLabel>Tab 2</IonLabel>
            </IonTabButton>
            <IonTabButton className="tab-btn" tab="tab3" href="/tab3">
              <IonIcon icon={square} />
              <IonLabel>Tab 3</IonLabel>
            </IonTabButton>
            <IonTabButton className="tab-btn" tab="tab4" href="/tab4">
              <IonIcon icon={heart} />
